 ...
 */
final class Version20231012131853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EA750E8ECBB55AF ON label');
        $this->addSql('ALTER TABLE label DROP albums_id, CHANGE description description TINYTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE label ADD albums_id INT DEFAULT NULL, CHANGE description description TEXT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_EA750E8ECBB55AF ON label (albums_id)');
